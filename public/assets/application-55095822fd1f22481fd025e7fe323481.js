...
(function() {
  ...
  App = (function(_super) {
    ...
    function App() {
      ...
      this.append(this.authorizations = new App.Authorizations);
      this.append(this.tasks = new App.Tasks);
      Spine.Route.setup();
    }
...
(function() {
  ...
  App.Task = (function(_super) {
    ...
    Task.configure('Task', 'name', 'status', 'created_at', 'priority');
...
(function() {
  ...
  App.User = (function(_super) {
    ...
    User.configure('User', 'username', 'api_key');

    User.extend(Spine.Model.Ajax);

    User.url = '/api/users/me';
    ...
    User.login = function(username, password, cb) {
      ...
      return $.post(url, params, function(data) {
        ...
        if (cb) {
          ...
          return console.log('Need a callback function to get the token');
        }
      });
    };

    User.register = function(params, cb) {
      var url;
      url = '/api/users';
      return $.post(url, params, function(data) {
        var res;
...
(function() {
  ...
  Index = (function(_super) {
    ...
    function Index() {
      this.set_auth_header = __bind(this.set_auth_header, this);
    ...
    Index.prototype.render = function() {
      ...
      if (token) {
        ...
        return this.html(this.view('authorizations/index'));
      }
    };
    ...
    Index.prototype.login = function() {
      ...
      return User.login(username, password, function(res) {
        var code;
        code = res.code;
        if (code > 0) {
          _this.html('');
          _this.set_token(res.token);
          _this.set_auth_header();
          User.fetch();
          return Task.fetch();
        } else {
    ...
    Index.prototype.register = function() {
      var params, password, password_confirmation, username,
        _this = this;
      ...
      return User.register(params, function(res) {
        var code;
        code = res.code;
        if (code > 0) {
          _this.html('');
    ...
    Index.prototype.set_token = function(token) {
      return window.localStorage.setItem('todolist:token', token);
    };

    Index.prototype.get_token = function() {
      return window.localStorage.getItem('todolist:token');
    };

    Index.prototype.set_auth_header = function(token) {
  ...
  App.Authorizations = (function(_super) {
    __extends(Authorizations, _super);

    function Authorizations() {
      _ref = Authorizations.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    Authorizations.prototype.controllers = {
      index: Index
    };

    Authorizations.prototype.routes = {
      '/authenticate': 'index'
    };

    Authorizations.prototype["default"] = 'index';

    Authorizations.prototype.className = 'stack authorizations';
...
(function() {
  ...
  Index = (function(_super) {
    ...
    function Index() {
      this.render = __bind(this.render, this);
      Index.__super__.constructor.apply(this, arguments);
      Task.bind('refresh change', this.render);
      if (this.get_token()) {
        User.fetch();
        Task.deleteAll();
        Task.fetch();
    ...
    Index.prototype.render = function() {
      ...
      return this.html(this.view('tasks/index')({
        tasks: tasks,
        user: user
      }));
    };
    ...
    Index.prototype.update = function(e) {
      var $el, name, priority, status, task, task_id;
    ...
    Index.prototype.logout = function(e) {
      ...
      this.html('');
      return this.navigate('/authenticate');
    };
  ...
  App.Tasks = (function(_super) {
    ...
    Tasks.prototype["default"] = 'index';

    Tasks.prototype.className = 'stack tasks';
...
(function() {
  ...
  Me = (function(_super) {
    ...
    function Me() {
      Me.__super__.constructor.apply(this, arguments);
      User.fetch();
    }
  ...
  App.Users = (function(_super) {
    ...
    Users.prototype["default"] = 'me';

    Users.prototype.className = 'stack users';
...
(function() { this.JST || (this.JST = {}); this.JST["app/views/authorizations/index"] = function(__obj) {
    if (!__obj) __obj = {};
...
(function() { this.JST || (this.JST = {}); this.JST["app/views/tasks/index"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
